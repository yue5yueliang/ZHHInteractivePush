...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    ZHHViewController *rootViewController = [[ZHHViewController alloc] init];
    UINavigationController *navigationController = [[UINavigationController alloc] initWithRootViewController:rootViewController];
    navigationController.navigationBar.prefersLargeTitles = YES;
    
    __weak typeof(rootViewController) weakRoot = rootViewController;
    [navigationController zhh_enableInteractivePushWithHandler:^UIViewController * _Nonnull{
